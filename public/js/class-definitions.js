...
var notWarmOrColdAnimal = new Animal('Panda', 'male').isWarmBlooded();
...
var closeAnOpenBox = new Box('doodoo', true).openBox();
 ...
 *
 */
var farTooTallAStory = new House(10).isATallStory(10);
...
var cookieMonsterBlocked = new Cookie('hazelnut').swipedByCookieMonster('Monday');
